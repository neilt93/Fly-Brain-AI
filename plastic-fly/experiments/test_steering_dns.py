...
# --- Test 3: Steering sensitivity (synthetic test) ---
print()
...
# Collect all unique readout IDs across both versions
all_v3_ids = set()
all_v5_ids = set()
...
# Scenario A: baseline -- all neurons at 20Hz
...
# Scenario B: DNa01/DNg13 LEFT neurons fire at 80Hz (others at 20Hz)
...
# Scenario C: DNa01/DNg13 RIGHT neurons fire at 80Hz (others at 20Hz)
...
# --- Test 4: Verify new neurons are actually in the right groups ---
print()
...
# --- Test 5: No accidental cross-contamination ---
print()
...
# --- Test 6: Decoder sensitivity to pure steering DN activation ---
print()
...
# --- Test 7: Turn drive asymmetry is symmetric (L boost = -R boost) ---
print()
...
# Threshold 0.02: asymmetry is expected due to pre-existing L/R group size
# difference (127L vs 155R). Same 3 neurons contribute different mean rates
